...
(function(global, factory) {
    ...
    $.fn.fullpage = function(options) {
        ...
        */
        ...
        /**
        * Scrolls to an element within the scrollable part of the page
        */
        FP.moveWithinScroller = function (sectionAnchor){
          myIScrollInstance.scrollToElement(sectionAnchor, 2000, 0, -100);
        };

        FP.moveWithinScrollerDown = function (){
          // ergänzen: nur wenn target position nicht höher als das fenster ist
          var scrollSpaceLeft = $(".fp-scroller").height() + myIScrollInstance.y - windowsHeight;
          var scrollamount;
          if(scrollSpaceLeft > 200) scrollamount = -windowsHeight + 200;
          else scrollamount = scrollSpaceLeft;
          if (scrollamount > 0) scrollamount = 0;


          // console.log($(".fp-scroller").height() + myIScrollInstance.y - windowsHeight + " // " +  (- (-windowsHeight + 200)));
          // console.log(scrollamount);
          myIScrollInstance.scrollBy(0, scrollamount, 1000);
        };
        ...
        */
        ...
        create: function(element, scrollHeight) {
            ...
            scrollable.each(function() {
                ...
                myIScrollInstance = iScrollInstance;
